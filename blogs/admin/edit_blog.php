...
$sql2 = "SELECT * FROM blog LEFT JOIN categories ON blog.category=categories.cat_id LEFT JOIN author ON blog.author_id = author.author_id WHERE blog_id='$blogID'";
			...
			<div class="card">
				...
				<div class="card-body">
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<div class="mb-3">
							<label>Clasic Description</label>
...
<script>
	...
	console.log(document.getElementById("editor").values);
</script>
